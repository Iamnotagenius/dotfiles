...
--  General keybinds
local toggle = require('toggleable').toggle
...
hl.bind("XF86Tools", function ()
    hl.dispatch(toggle("ncmpcpp", "alacritty -T ncmpcpp -e ncmpcpp"))
end)
hl.bind("SHIFT + XF86Tools", function ()
    hl.dispatch(toggle("pavucontrol", "pavucontrol"))
end)
hl.bind("CONTROL + XF86Tools", function ()
    hl.dispatch(toggle("btop", "alacritty --option font.size=10 -T btop -e btop -p 1"))
end)
hl.bind("XF86Calculator", function ()
    hl.dispatch(toggle("calc", "alacritty -T calc -e calc -d"))
end)
